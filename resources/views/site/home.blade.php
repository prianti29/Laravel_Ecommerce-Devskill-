        ...
        <div class="slide-visual">
            ...
            <div class="script-wrap">
                <ul class="script-group">
                    <li>
                        <div class="inner-script"><img class="img-responsive" src="/site/images/baa1.jpg" alt="Dummy Image" />
                        </div>
                    </li>
                    <li>
                        <div class="inner-script"><img class="img-responsive" src="/site/images/baa2.jpg" alt="Dummy Image" />
                        </div>
                    </li>
                    <li>
                        <div class="inner-script"><img class="img-responsive" src="/site/images/baa3.jpg" alt="Dummy Image" />
                        </div>
                    </li>
                </ul>
